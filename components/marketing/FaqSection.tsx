...
export default function FaqSection() {
  ...
  const faqs = [
    {
      q: 'O que faz a plataforma ViralForge AI?',
  ...
  return (
    <section id="faq-section-root" className="relative w-full bg-[#0A0A0F] py-24 sm:py-32 px-6 md:px-12 border-b border-[#1E1E2E]">
