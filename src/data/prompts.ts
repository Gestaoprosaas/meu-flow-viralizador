...
export const MOVEMENTS_PRESETS: MovementPreset[] = [
  {
    ...
    imageUrl: '/videos/movimentos/Beijo + CTA.mp4',
    videoUrl: '/videos/movimentos/Beijo + CTA.mp4',
...
Ambiente: fundo levemente desfocado. Movimento natural dos cabelos ao inclinar. Leve sensação de profundidade realista. Mãos anatomicamente corretas. Sem distorção dos dedos. Manter consistência total da aparência do cabelo do início ao fim.`,
  },
  {
    ...
    imageUrl: '/videos/avatares/Tapar Camera.mp4',
    videoUrl: '/videos/avatares/Tapar Camera.mp4',
...
FINAL RESULT: A hyper-realistic casual fashion transition video where the subject naturally walks toward the camera, softly covers the lens with one hand for a transition, then steps back into a relaxed feminine final pose.`,
  ...
  {
    id: 'Mexendo no Cabelo 1',
    name: 'Mexendo no Cabelo 1',
    type: 'Movimentos',
    format: 'Video',
    description: 'A avatar mexe no cabelo de forma natural e sedutora, com leve sorriso',
    imageUrl: '/videos/avatares/Person_presenting_clothing_POV_202606281521.mp4',
    videoUrl: '/videos/avatares/Person_presenting_clothing_POV_202606281521.mp4',
...
– During the bow/lace touch:
  ...
  },
  {
    ...
    imageUrl: '/videos/avatares/360 CONTROLADO.mp4',
    videoUrl: '/videos/avatares/360 CONTROLADO.mp4',
    promptText: `{
  "version": "3.1",
  "aspectRatio": "9:16",
  "durationSeconds": 8,
  ...
  },
  {
    ...
    imageUrl: '/videos/avatares/Girl_stepping_forward_with_clothing_202606281557.mp4',
    videoUrl: '/videos/avatares/Girl_stepping_forward_with_clothing_202606281557.mp4',
...
The animation should feel like a real girl casually stepping forward and softly placing the clothing in front of the phone camera for a natural TikTok-style transition.`
  },
  {
    ...
    imageUrl: '/videos/movimentos/animacaonatural.mp4',
    videoUrl: '/videos/movimentos/animacaonatural.mp4',
  ...
  },
  {
    ...
    imageUrl: '/videos/movimentos/colocando capus.mp4',
    videoUrl: '/videos/movimentos/colocando capus.mp4',
  ...
  },
  {
    ...
    imageUrl: '/videos/movimentos/cta1.mp4',
    videoUrl: '/videos/movimentos/cta1.mp4',
  ...
  },
  {
    ...
    format: 'Video',
    description: 'A avatar apresenta o look completo em espelho, finalizando com gesto de apontar para o link da bio ou texto "Compre Agora"',
    imageUrl: '/videos/movimentos/cta2.mp4',
    videoUrl: '/videos/movimentos/cta2.mp4',
  ...
  },
  {
    ...
    format: 'Video',
    description: 'A avatar apresenta o look completo em espelho, finalizando com gesto de apontar para o link da bio ou texto "Compre Agora"',
    imageUrl: '/videos/movimentos/cta3.mp4',
    videoUrl: '/videos/movimentos/cta3.mp4',
  ...
  },
  {
    ...
    imageUrl: '/videos/movimentos/gancho normal.mp4',
    videoUrl: '/videos/movimentos/gancho normal.mp4',
  ...
  },
  {
    ...
    format: 'Video',
    description: 'A avatar mexe no cabelo de forma natural e sedutora, com leve sorriso',
    imageUrl: '/videos/movimentos/mexendo cabelo.mp4',
    videoUrl: '/videos/movimentos/mexendo cabelo.mp4',
  ...
  },
  {
    ...
    imageUrl: '/videos/movimentos/pacote tiktok.mp4',
    videoUrl: '/videos/movimentos/pacote tiktok.mp4',
  ...
  },
  {
    ...
    imageUrl: '/videos/movimentos/ULTRA REALISTA MEXENDO CABELO.mp4',
    videoUrl: '/videos/movimentos/ULTRA REALISTA MEXENDO CABELO.mp4',
  ...
  },
  {
    ...
    imageUrl: '/videos/movimentos/VIRANDO DE COSTA.mp4',
    videoUrl: '/videos/movimentos/VIRANDO DE COSTA.mp4',
  ...
  },
  {
    ...
    type: 'Movimentos',
    format: 'Video',
    description: 'A avatar fecha o zíper de uma peça de roupa de forma natural e fluida, com movimentos suaves e expressão facial confiante',
    imageUrl: '/videos/movimentos/ziper.mp4',
    videoUrl: '/videos/movimentos/ziper.mp4',
    promptText: ' "intent": "clean_zipper_close_only",  "camera": {    "tripod": true,    "locked": true,    "no_movement": true,    "no_zoom": true,    "no_reframe": true  },  "audio": {    "enabled": false,    "no_speaking": true  },  "timing": {    "duration": "3_to_5_seconds",    "tempo": "natural_controlled",    "no_slow_motion": true  },  "sequence": [    {      "action": "start_front_pose",      "posture": "neutral_natural",      "expression": "soft_relaxed"    },    {      "action": "look_down_at_zipper",      "head_movement": "slight_downward",      "eyes_focus": "zipper_slider_center_chest"    },    {      "action": "two_hand_zipper_close",      "hands": "both_hands",      "left_hand": {        "role": "hold_zipper_edges",        "position": "fabric_edges_next_to_center_zipper",        "function": "stabilize_both_sides_of_top"      },      "right_hand": {        "role": "grab_zipper_slider",        "target": "visible_zipper_puller",        "gesture": "pinch_zipper_tab_between_fingers"      },      "movement": {        "start_point": "center_front_zipper_mid_chest",        "end_point": "upper_front_zipper",        "path": "along_center_zipper_track_only",        "direction": "straight_up",        "speed": "controlled_natural",        "single_clean_pull": true,        "zipper_slider_must_visibly_move": true,        "do_not_pull_bottom_hem": true,        "do_not_lift_entire_top": true      }    },    {      "action": "release_hands",      "style": "natural_drop",      "expression": "subtle_soft_smile"    }  ],  "rules": {    "no_extra_movement": true,    "no_body_turn": true,    "no_steps": true,    "no_exaggeration": true,    "must_use_both_hands": true,    "must_grab_zipper_slider_not_fabric_bottom": true,    "must_follow_center_zipper_track": true,    "preserve_identity": true  }}GENERATE ANIMATED BACKGROUND MUSIC'
  },
 ];