...
export default function ProblemSection() {
  ...
  return (
    <section ref={containerRef} id="problem-section" className="relative w-full bg-[#0A0A0F]/45 backdrop-blur-md py-24 sm:py-32 px-6 md:px-12 border-b border-[#1E1E2E]">
      
      {/* Dynamic backdrop grid sutil line */}
      ...
      <div className="max-w-7xl mx-auto space-y-20 relative z-10">
        ...
        {/* 3 Horizontal Cards aligned dynamically */}
            ...
            return (
              ...
              >
                <div className={`relative h-full bg-[#0A0A0F]/60 backdrop-blur-md border border-white/[0.04] p-8 rounded-2xl transition-all duration-300 ${card.borderColor} ${card.glowColor} flex flex-col justify-between`}>
                  ...
                  {/* Top segment */}
                  <div>
                    {/* Circle Icon size standard 48px */}
                  ...
                  {/* Micro metric label for aesthetic density */}
                  <div className="border-t border-white/[0.03] pt-4 mt-6 flex justify-between items-center">
                    <span className="text-[9px] font-mono text-gray-600 uppercase">Estágio Solucionado</span>
