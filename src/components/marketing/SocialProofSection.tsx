...
export default function SocialProofSection() {
  ...
  return (
    <section ref={containerRef} id="social-proof-section" className="relative w-full bg-[#0A0A0F]/45 backdrop-blur-md py-24 sm:py-32 px-6 md:px-12 border-b border-[#1E1E2E] overflow-hidden">
          ...
          {testimonials.map((test, idx) => (
            ...
            >
              <div className="bg-[#111118]/80 border border-white/[0.04] rounded-2xl p-8 h-full flex flex-col justify-between group hover:border-white/[0.08] transition-colors duration-300 relative overflow-hidden">
                ...
                {/* Visual block decorative background ripple */}
